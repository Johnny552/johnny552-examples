      ...
      0000BB 75 A1 55         [24]  580 	mov	_SAFE_MOD,#0x55
                                    581 ;	../../include/debug.c:27: SAFE_MOD = 0xAA;
      0000BE 75 A1 AA         [24]  582 	mov	_SAFE_MOD,#0xaa
                                    583 ;	../../include/debug.c:34: CLOCK_CFG = CLOCK_CFG & ~ MASK_SYS_CK_SEL | 0x06;  // 24MHz	
      0000C1 74 F8            [12]  584 	mov	a,#0xf8
      0000C3 55 B9            [12]  585 	anl	a,_CLOCK_CFG
      0000C5 44 06            [12]  586 	orl	a,#0x06
      0000C7 F5 B9            [12]  587 	mov	_CLOCK_CFG,a
                                    588 ;	../../include/debug.c:51: SAFE_MOD = 0x00;
      0000C9 75 A1 00         [24]  589 	mov	_SAFE_MOD,#0x00
      ...
      0000CC 22               [24]  591 	ret
                                    ...
                                    600 ;	-----------------------------------------
      0000CD                        601 _mDelayuS:
      0000CD AE 82            [24]  602 	mov	r6, dpl
      0000CF AF 83            [24]  603 	mov	r7, dph
                                    604 ;	../../include/debug.c:76: while ( n ) {  // total = 12~13 Fsys cycles, 1uS @Fsys=12MHz
      0000D1                        605 00101$:
      0000D1 EE               [12]  606 	mov	a,r6
      0000D2 4F               [12]  607 	orl	a,r7
      0000D3 60 15            [24]  608 	jz	00104$
                                    609 ;	../../include/debug.c:77: ++ SAFE_MOD;  // 2 Fsys cycles, for higher Fsys, add operation here
      0000D5 05 A1            [12]  610 	inc	_SAFE_MOD
                                    611 ;	../../include/debug.c:80: ++ SAFE_MOD;
      0000D7 05 A1            [12]  612 	inc	_SAFE_MOD
                                    613 ;	../../include/debug.c:83: ++ SAFE_MOD;
      0000D9 05 A1            [12]  614 	inc	_SAFE_MOD
                                    615 ;	../../include/debug.c:86: ++ SAFE_MOD;
      0000DB 05 A1            [12]  616 	inc	_SAFE_MOD
                                    617 ;	../../include/debug.c:89: ++ SAFE_MOD;
      0000DD 05 A1            [12]  618 	inc	_SAFE_MOD
                                    619 ;	../../include/debug.c:92: ++ SAFE_MOD;
      0000DF 05 A1            [12]  620 	inc	_SAFE_MOD
                                    621 ;	../../include/debug.c:95: ++ SAFE_MOD;
      0000E1 05 A1            [12]  622 	inc	_SAFE_MOD
                                    623 ;	../../include/debug.c:110: -- n;
      0000E3 1E               [12]  624 	dec	r6
      0000E4 BE FF 01         [24]  625 	cjne	r6,#0xff,00120$
      0000E7 1F               [12]  626 	dec	r7
      0000E8                        627 00120$:
      0000E8 80 E7            [24]  628 	sjmp	00101$
      0000EA                        629 00104$:
      ...
      0000EA 22               [24]  631 	ret
                                    ...
                                    640 ;	-----------------------------------------
      0000EB                        641 _mDelaymS:
      0000EB AE 82            [24]  642 	mov	r6, dpl
      0000ED AF 83            [24]  643 	mov	r7, dph
                                    644 ;	../../include/debug.c:123: while ( n ) {
      0000EF                        645 00101$:
      0000EF EE               [12]  646 	mov	a,r6
      0000F0 4F               [12]  647 	orl	a,r7
      0000F1 60 15            [24]  648 	jz	00104$
                                    649 ;	../../include/debug.c:128: mDelayuS( 1000 );
      0000F3 90 03 E8         [24]  650 	mov	dptr,#0x03e8
      0000F6 C0 07            [24]  651 	push	ar7
      0000F8 C0 06            [24]  652 	push	ar6
      0000FA 12 00 CD         [24]  653 	lcall	_mDelayuS
      0000FD D0 06            [24]  654 	pop	ar6
      0000FF D0 07            [24]  655 	pop	ar7
                                    656 ;	../../include/debug.c:130: -- n;
      000101 1E               [12]  657 	dec	r6
      000102 BE FF 01         [24]  658 	cjne	r6,#0xff,00120$
      000105 1F               [12]  659 	dec	r7
      000106                        660 00120$:
      000106 80 E7            [24]  661 	sjmp	00101$
      000108                        662 00104$:
                                    663 ;	../../include/debug.c:132: }                                         
      000108 22               [24]  664 	ret
                                    665 ;------------------------------------------------------------
                                    ...
                                    673 ;	-----------------------------------------
      000109                        674 _putchar:
      000109 AE 82            [24]  675 	mov	r6, dpl
      00010B AF 83            [24]  676 	mov	r7, dph
                                    677 ;	../../include/debug.c:150: while (!TI); /* assumes UART is initialized */
      00010D                        678 00101$:
                                    679 ;	../../include/debug.c:151: TI = 0;
                                    680 ;	assignBit
      00010D 10 99 02         [24]  681 	jbc	_TI,00118$
      000110 80 FB            [24]  682 	sjmp	00101$
      000112                        683 00118$:
                                    684 ;	../../include/debug.c:152: SBUF = c & 0xFF;
      000112 8E 99            [24]  685 	mov	_SBUF,r6
                                    686 ;	../../include/debug.c:154: return c;
      000114 8E 82            [24]  687 	mov	dpl, r6
      000116 8F 83            [24]  688 	mov	dph, r7
                                    689 ;	../../include/debug.c:155: }
      000118 22               [24]  690 	ret
                                    691 ;------------------------------------------------------------
      ...
      000119                        700 00101$:
                                    ...
                                    702 ;	assignBit
      000119 10 98 02         [24]  703 	jbc	_RI,00118$
      00011C 80 FB            [24]  704 	sjmp	00101$
      00011E                        705 00118$:
                                    706 ;	../../include/debug.c:160: return SBUF;
      00011E AE 99            [24]  707 	mov	r6,_SBUF
      000120 7F 00            [12]  708 	mov	r7,#0x00
      000122 8E 82            [24]  709 	mov	dpl, r6
      000124 8F 83            [24]  710 	mov	dph, r7
                                    711 ;	../../include/debug.c:161: }
      000126 22               [24]  712 	ret
                                    713 	.area CSEG    (CODE)
                                    714 	.area CONST   (CODE)
                                    715 	.area XINIT   (CODE)

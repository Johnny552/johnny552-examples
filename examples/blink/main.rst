                                     ...
                                     12 	.globl _mDelaymS
                                     13 	.globl _CfgFsys
                                     14 	.globl _SK6812_BIT
                                     15 	.globl _PIN_11_BIT
                                     16 	.globl _PIN_10_BIT
                                     17 	.globl _PIN_9_BIT
                                     18 	.globl _PIN_8_BIT
                                     19 	.globl _PIN_7_BIT
                                     20 	.globl _PIN_5_BIT
                                    ...
                                    151 	.globl _AC
                                    152 	.globl _CY
                                    153 	.globl _UEP1_DMA_H
                                    154 	.globl _UEP1_DMA_L
                                    155 	.globl _UEP1_DMA
                                    156 	.globl _UEP0_DMA_H
                                    157 	.globl _UEP0_DMA_L
                                    158 	.globl _UEP0_DMA
                                    159 	.globl _UEP2_3_MOD
                                    160 	.globl _UEP4_1_MOD
                                    161 	.globl _UEP3_DMA_H
                                    162 	.globl _UEP3_DMA_L
                                    163 	.globl _UEP3_DMA
                                    164 	.globl _UEP2_DMA_H
                                    165 	.globl _UEP2_DMA_L
                                    166 	.globl _UEP2_DMA
                                    167 	.globl _USB_DEV_AD
                                    168 	.globl _USB_CTRL
                                    169 	.globl _USB_INT_EN
                                    170 	.globl _UEP4_T_LEN
                                    171 	.globl _UEP4_CTRL
                                    172 	.globl _UEP0_T_LEN
                                    173 	.globl _UEP0_CTRL
                                    174 	.globl _USB_RX_LEN
                                    175 	.globl _USB_MIS_ST
                                    176 	.globl _USB_INT_ST
                                    177 	.globl _USB_INT_FG
                                    178 	.globl _UEP3_T_LEN
                                    179 	.globl _UEP3_CTRL
                                    180 	.globl _UEP2_T_LEN
                                    181 	.globl _UEP2_CTRL
                                    182 	.globl _UEP1_T_LEN
                                    183 	.globl _UEP1_CTRL
                                    184 	.globl _UDEV_CTRL
                                    185 	.globl _USB_C_CTRL
                                    186 	.globl _TKEY_DATH
                                    187 	.globl _TKEY_DATL
                                    188 	.globl _TKEY_DAT
                                    189 	.globl _TKEY_CTRL
                                    190 	.globl _ADC_DATA
                                    191 	.globl _ADC_CFG
                                    192 	.globl _ADC_CTRL
                                    193 	.globl _SBAUD1
                                    ...
                                    201 	.globl _PWM_CK_SE
                                    202 	.globl _PWM_CTRL
                                    203 	.globl _PWM_DATA1
                                    204 	.globl _PWM_DATA2
                                    205 	.globl _T2CAP1H
                                    206 	.globl _T2CAP1L
                                    207 	.globl _T2CAP1
                                    208 	.globl _TH2
                                    ...
                                    224 	.globl _XBUS_AUX
                                    225 	.globl _PIN_FUNC
                                    226 	.globl _P3_DIR_PU
                                    227 	.globl _P3_MOD_OC
                                    228 	.globl _P3
                                    229 	.globl _P2
                                    230 	.globl _P1_DIR_PU
                                    231 	.globl _P1_MOD_OC
                                    232 	.globl _P1
                                    233 	.globl _ROM_CTRL
                                    234 	.globl _ROM_DATA_H
                                    235 	.globl _ROM_DATA_L
                                    236 	.globl _ROM_DATA
                                    237 	.globl _ROM_ADDR_H
                                    238 	.globl _ROM_ADDR_L
                                    239 	.globl _ROM_ADDR
                                    240 	.globl _GPIO_IE
                                    241 	.globl _IP_EX
                                    242 	.globl _IE_EX
                                    243 	.globl _IP
                                    244 	.globl _IE
                                    245 	.globl _WDOG_COUNT
                                    246 	.globl _RESET_KEEP
                                    247 	.globl _WAKE_CTRL
                                    248 	.globl _CLOCK_CFG
                                    249 	.globl _PCON
                                    250 	.globl _GLOBAL_CFG
                                    251 	.globl _SAFE_MOD
                                    252 	.globl _DPH
                                    253 	.globl _DPL
                                    254 	.globl _SP
      ...
      000000                        372 	.org 0x0000
                           ...
                           000094   502 _PIN_2_BIT	=	0x0094
                           000096   503 _PIN_3_BIT	=	0x0096
                           000097   504 _PIN_4_BIT	=	0x0097
                           000095   505 _PIN_5_BIT	=	0x0095
                           000091   506 _PIN_7_BIT	=	0x0091
                           0000B1   507 _PIN_8_BIT	=	0x00b1
                           0000B0   508 _PIN_9_BIT	=	0x00b0
                           0000B3   509 _PIN_10_BIT	=	0x00b3
                           0000B4   510 _PIN_11_BIT	=	0x00b4
                           000090   511 _SK6812_BIT	=	0x0090
                                    512 ;--------------------------------------------------------
      ...
      000000 02 00 4C         [24]  575 	ljmp	__sdcc_gsinit_startup
                                    576 ; restartable atomic support routines
      000003                        577 	.ds	5
      000008                        578 sdcc_atomic_exchange_rollback_start::
      000008 00               [12]  579 	nop
      000009 00               [12]  580 	nop
      00000A                        581 sdcc_atomic_exchange_pdata_impl:
      00000A E2               [24]  582 	movx	a, @r0
      00000B FB               [12]  583 	mov	r3, a
      00000C EA               [12]  584 	mov	a, r2
      00000D F2               [24]  585 	movx	@r0, a
      00000E 80 2C            [24]  586 	sjmp	sdcc_atomic_exchange_exit
      000010 00               [12]  587 	nop
      000011 00               [12]  588 	nop
      000012                        589 sdcc_atomic_exchange_xdata_impl:
      000012 E0               [24]  590 	movx	a, @dptr
      000013 FB               [12]  591 	mov	r3, a
      000014 EA               [12]  592 	mov	a, r2
      000015 F0               [24]  593 	movx	@dptr, a
      000016 80 24            [24]  594 	sjmp	sdcc_atomic_exchange_exit
      000018                        595 sdcc_atomic_compare_exchange_idata_impl:
      000018 E6               [12]  596 	mov	a, @r0
      000019 B5 02 02         [24]  597 	cjne	a, ar2, .+#5
      00001C EB               [12]  598 	mov	a, r3
      00001D F6               [12]  599 	mov	@r0, a
      00001E 22               [24]  600 	ret
      00001F 00               [12]  601 	nop
      000020                        602 sdcc_atomic_compare_exchange_pdata_impl:
      000020 E2               [24]  603 	movx	a, @r0
      000021 B5 02 02         [24]  604 	cjne	a, ar2, .+#5
      000024 EB               [12]  605 	mov	a, r3
      000025 F2               [24]  606 	movx	@r0, a
      000026 22               [24]  607 	ret
      000027 00               [12]  608 	nop
      000028                        609 sdcc_atomic_compare_exchange_xdata_impl:
      000028 E0               [24]  610 	movx	a, @dptr
      000029 B5 02 02         [24]  611 	cjne	a, ar2, .+#5
      00002C EB               [12]  612 	mov	a, r3
      00002D F0               [24]  613 	movx	@dptr, a
      00002E 22               [24]  614 	ret
      00002F                        615 sdcc_atomic_exchange_rollback_end::
                                    616 
      00002F                        617 sdcc_atomic_exchange_gptr_impl::
      00002F 30 F6 E0         [24]  618 	jnb	b.6, sdcc_atomic_exchange_xdata_impl
      000032 A8 82            [24]  619 	mov	r0, dpl
      000034 20 F5 D3         [24]  620 	jb	b.5, sdcc_atomic_exchange_pdata_impl
      000037                        621 sdcc_atomic_exchange_idata_impl:
      000037 EA               [12]  622 	mov	a, r2
      000038 C6               [12]  623 	xch	a, @r0
      000039 F5 82            [12]  624 	mov	dpl, a
      00003B 22               [24]  625 	ret
      00003C                        626 sdcc_atomic_exchange_exit:
      00003C 8B 82            [24]  627 	mov	dpl, r3
      00003E 22               [24]  628 	ret
      00003F                        629 sdcc_atomic_compare_exchange_gptr_impl::
      00003F 30 F6 E6         [24]  630 	jnb	b.6, sdcc_atomic_compare_exchange_xdata_impl
      000042 A8 82            [24]  631 	mov	r0, dpl
      000044 20 F5 D9         [24]  632 	jb	b.5, sdcc_atomic_compare_exchange_pdata_impl
      000047 80 CF            [24]  633 	sjmp	sdcc_atomic_compare_exchange_idata_impl
                                    634 ;--------------------------------------------------------
                                    ...
                                    641 	.globl __sdcc_gsinit_startup
                                    642 	.globl __sdcc_program_startup
                                    643 	.globl __start__stack
                                    644 	.globl __mcs51_genXINIT
                                    645 	.globl __mcs51_genXRAMCLEAR
                                    646 	.globl __mcs51_genRAMCLEAR
                                    647 	.area GSFINAL (CODE)
      0000A5 02 00 49         [24]  648 	ljmp	__sdcc_program_startup
                                    649 ;--------------------------------------------------------
                                    650 ; Home
                                    651 ;--------------------------------------------------------
                                    652 	.area HOME    (CODE)
                                    653 	.area HOME    (CODE)
      000049                        654 __sdcc_program_startup:
      000049 02 00 A8         [24]  655 	ljmp	_main
                                    656 ;	return from main will return to caller
                                    657 ;--------------------------------------------------------
                                    658 ; code
                                    659 ;--------------------------------------------------------
                                    660 	.area CSEG    (CODE)
      ...
      0000A8                        668 _main:
                           ...
                           000001   675 	ar1 = 0x01
                           000000   676 	ar0 = 0x00
                                    677 ;	main.c:5: CfgFsys();
      0000A8 12 00 BB         [24]  678 	lcall	_CfgFsys
                                    679 ;	main.c:8: P1_MOD_OC &= ~(1 << PIN_4);
      0000AB 53 92 7F         [24]  680 	anl	_P1_MOD_OC,#0x7f
                                    681 ;	main.c:9: P1_DIR_PU |=  (1 << PIN_4);
      0000AE 43 93 80         [24]  682 	orl	_P1_DIR_PU,#0x80
                                    683 ;	main.c:11: while (1) {
      0000B1                        684 00102$:
                                    685 ;	main.c:12: PIN_4_BIT = !PIN_4_BIT;
      0000B1 B2 97            [12]  686 	cpl	_PIN_4_BIT
                                    687 ;	main.c:13: mDelaymS(200);
      0000B3 90 00 C8         [24]  688 	mov	dptr,#0x00c8
      0000B6 12 00 EB         [24]  689 	lcall	_mDelaymS
                                    690 ;	main.c:15: }
      0000B9 80 F6            [24]  691 	sjmp	00102$
                                    692 	.area CSEG    (CODE)
                                    693 	.area CONST   (CODE)
                                    694 	.area XINIT   (CODE)

      ...
      000000 02 00 4C         [24]  563 	ljmp	__sdcc_gsinit_startup
                                    564 ; restartable atomic support routines
      000003                        565 	.ds	5
      000008                        566 sdcc_atomic_exchange_rollback_start::
      000008 00               [12]  567 	nop
      000009 00               [12]  568 	nop
      00000A                        569 sdcc_atomic_exchange_pdata_impl:
      00000A E2               [24]  570 	movx	a, @r0
      00000B FB               [12]  571 	mov	r3, a
      00000C EA               [12]  572 	mov	a, r2
      00000D F2               [24]  573 	movx	@r0, a
      00000E 80 2C            [24]  574 	sjmp	sdcc_atomic_exchange_exit
      000010 00               [12]  575 	nop
      000011 00               [12]  576 	nop
      000012                        577 sdcc_atomic_exchange_xdata_impl:
      000012 E0               [24]  578 	movx	a, @dptr
      000013 FB               [12]  579 	mov	r3, a
      000014 EA               [12]  580 	mov	a, r2
      000015 F0               [24]  581 	movx	@dptr, a
      000016 80 24            [24]  582 	sjmp	sdcc_atomic_exchange_exit
      000018                        583 sdcc_atomic_compare_exchange_idata_impl:
      000018 E6               [12]  584 	mov	a, @r0
      000019 B5 02 02         [24]  585 	cjne	a, ar2, .+#5
      00001C EB               [12]  586 	mov	a, r3
      00001D F6               [12]  587 	mov	@r0, a
      00001E 22               [24]  588 	ret
      00001F 00               [12]  589 	nop
      000020                        590 sdcc_atomic_compare_exchange_pdata_impl:
      000020 E2               [24]  591 	movx	a, @r0
      000021 B5 02 02         [24]  592 	cjne	a, ar2, .+#5
      000024 EB               [12]  593 	mov	a, r3
      000025 F2               [24]  594 	movx	@r0, a
      000026 22               [24]  595 	ret
      000027 00               [12]  596 	nop
      000028                        597 sdcc_atomic_compare_exchange_xdata_impl:
      000028 E0               [24]  598 	movx	a, @dptr
      000029 B5 02 02         [24]  599 	cjne	a, ar2, .+#5
      00002C EB               [12]  600 	mov	a, r3
      00002D F0               [24]  601 	movx	@dptr, a
      00002E 22               [24]  602 	ret
      00002F                        603 sdcc_atomic_exchange_rollback_end::
                                    604 
      00002F                        605 sdcc_atomic_exchange_gptr_impl::
      00002F 30 F6 E0         [24]  606 	jnb	b.6, sdcc_atomic_exchange_xdata_impl
      000032 A8 82            [24]  607 	mov	r0, dpl
      000034 20 F5 D3         [24]  608 	jb	b.5, sdcc_atomic_exchange_pdata_impl
      000037                        609 sdcc_atomic_exchange_idata_impl:
      000037 EA               [12]  610 	mov	a, r2
      000038 C6               [12]  611 	xch	a, @r0
      000039 F5 82            [12]  612 	mov	dpl, a
      00003B 22               [24]  613 	ret
      00003C                        614 sdcc_atomic_exchange_exit:
      00003C 8B 82            [24]  615 	mov	dpl, r3
      00003E 22               [24]  616 	ret
      00003F                        617 sdcc_atomic_compare_exchange_gptr_impl::
      00003F 30 F6 E6         [24]  618 	jnb	b.6, sdcc_atomic_compare_exchange_xdata_impl
      000042 A8 82            [24]  619 	mov	r0, dpl
      000044 20 F5 D9         [24]  620 	jb	b.5, sdcc_atomic_compare_exchange_pdata_impl
      000047 80 CF            [24]  621 	sjmp	sdcc_atomic_compare_exchange_idata_impl
                                    622 ;--------------------------------------------------------
                                    ...
                                    629 	.globl __sdcc_gsinit_startup
                                    630 	.globl __sdcc_program_startup
                                    631 	.globl __start__stack
                                    632 	.globl __mcs51_genXINIT
                                    633 	.globl __mcs51_genXRAMCLEAR
                                    634 	.globl __mcs51_genRAMCLEAR
                                    635 	.area GSFINAL (CODE)
      0000A5 02 00 49         [24]  636 	ljmp	__sdcc_program_startup
                                    637 ;--------------------------------------------------------
                                    638 ; Home
                                    639 ;--------------------------------------------------------
                                    640 	.area HOME    (CODE)
                                    641 	.area HOME    (CODE)
      000049                        642 __sdcc_program_startup:
      000049 02 00 A8         [24]  643 	ljmp	_main
                                    ...
                                    648 	.area CSEG    (CODE)
                                    649 ;------------------------------------------------------------
                                    650 ;Allocation info for local variables in function 'main'
                                    651 ;------------------------------------------------------------
                                    652 ;	main.c:28: void main(void)
                                    653 ;	-----------------------------------------
                                    654 ;	 function main
                                    655 ;	-----------------------------------------
      0000A8                        656 _main:
                           ...
                           000001   663 	ar1 = 0x01
                           000000   664 	ar0 = 0x00
                                    665 ;	main.c:30: CfgFsys();     // 24 MHz clock
      0000A8 12 00 E3         [24]  666 	lcall	_CfgFsys
                                    667 ;	main.c:31: mDelaymS(5);
      0000AB 90 00 05         [24]  668 	mov	dptr,#0x0005
      0000AE 12 01 13         [24]  669 	lcall	_mDelaymS
                                    670 ;	main.c:33: USBInit();
      0000B1 12 00 00         [24]  671 	lcall	_USBInit
                                    672 ;	main.c:35: while(1) {
      0000B4                        673 00102$:
                                    674 ;	main.c:36: USBPoll();
      0000B4 12 00 00         [24]  675 	lcall	_USBPoll
                                    676 ;	main.c:39: memcpy(txBuffer, "HELLO\n", 6);
      0000B7 75 08 FC         [24]  677 	mov	___memcpy_PARM_2,#___str_0
      0000BA 75 09 01         [24]  678 	mov	(___memcpy_PARM_2 + 1),#(___str_0 >> 8)
      0000BD 75 0A 80         [24]  679 	mov	(___memcpy_PARM_2 + 2),#0x80
      0000C0 75 0B 06         [24]  680 	mov	___memcpy_PARM_3,#0x06
      0000C3 75 0C 00         [24]  681 	mov	(___memcpy_PARM_3 + 1),#0x00
      0000C6 90 00 00         [24]  682 	mov	dptr,#_txBuffer
      0000C9 75 F0 00         [24]  683 	mov	b, #0x00
      0000CC 12 01 4F         [24]  684 	lcall	___memcpy
                                    685 ;	main.c:40: USBWrite(txBuffer, 6);
      0000CF 75 00 06         [24]  686 	mov	_USBWrite_PARM_2,#0x06
      0000D2 90 00 00         [24]  687 	mov	dptr,#_txBuffer
      0000D5 75 F0 00         [24]  688 	mov	b, #0x00
      0000D8 12 00 00         [24]  689 	lcall	_USBWrite
                                    690 ;	main.c:41: mDelaymS(1000);
      0000DB 90 03 E8         [24]  691 	mov	dptr,#0x03e8
      0000DE 12 01 13         [24]  692 	lcall	_mDelaymS
                                    693 ;	main.c:43: }
      0000E1 80 D1            [24]  694 	sjmp	00102$
                                    695 	.area CSEG    (CODE)
                                    696 	.area CONST   (CODE)
                                    697 	.area CONST   (CODE)
      0001DF                        698 _ReportDescriptor:
      0001DF 06                     699 	.db #0x06	; 6
      0001E0 00                     700 	.db #0x00	; 0
      0001E1 FF                     701 	.db #0xff	; 255
      0001E2 09                     702 	.db #0x09	; 9
      0001E3 01                     703 	.db #0x01	; 1
      0001E4 A1                     704 	.db #0xa1	; 161
      0001E5 01                     705 	.db #0x01	; 1
      0001E6 15                     706 	.db #0x15	; 21
      0001E7 00                     707 	.db #0x00	; 0
      0001E8 26                     708 	.db #0x26	; 38
      0001E9 FF                     709 	.db #0xff	; 255
      0001EA 00                     710 	.db #0x00	; 0
      0001EB 75                     711 	.db #0x75	; 117	'u'
      0001EC 08                     712 	.db #0x08	; 8
      0001ED 95                     713 	.db #0x95	; 149
      0001EE 08                     714 	.db #0x08	; 8
      0001EF 09                     715 	.db #0x09	; 9
      0001F0 00                     716 	.db #0x00	; 0
      0001F1 82                     717 	.db #0x82	; 130
      0001F2 02                     718 	.db #0x02	; 2
      0001F3 01                     719 	.db #0x01	; 1
      0001F4 95                     720 	.db #0x95	; 149
      0001F5 08                     721 	.db #0x08	; 8
      0001F6 09                     722 	.db #0x09	; 9
      0001F7 00                     723 	.db #0x00	; 0
      0001F8 92                     724 	.db #0x92	; 146
      0001F9 02                     725 	.db #0x02	; 2
      0001FA 01                     726 	.db #0x01	; 1
      0001FB C0                     727 	.db #0xc0	; 192
                                    728 	.area CSEG    (CODE)
                                    729 	.area CONST   (CODE)
      0001FC                        730 ___str_0:
      0001FC 48 45 4C 4C 4F         731 	.ascii "HELLO"
      000201 0A                     732 	.db 0x0a
      000202 00                     733 	.db 0x00
                                    734 	.area CSEG    (CODE)
                                    735 	.area XINIT   (CODE)

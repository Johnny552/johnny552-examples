      ...
      000000                        498 	.ds 8
                                    ...
                                    565 ;------------------------------------------------------------
                                    566 ;	../../include/debug.c:24: void	CfgFsys(void)  
                                    567 ;	-----------------------------------------
      ...
      0000E3                        570 _CfgFsys:
                           ...
                           000001   577 	ar1 = 0x01
                           000000   578 	ar0 = 0x00
                                    579 ;	../../include/debug.c:26: SAFE_MOD = 0x55;
      0000E3 75 A1 55         [24]  580 	mov	_SAFE_MOD,#0x55
                                    581 ;	../../include/debug.c:27: SAFE_MOD = 0xAA;
      0000E6 75 A1 AA         [24]  582 	mov	_SAFE_MOD,#0xaa
                                    583 ;	../../include/debug.c:34: CLOCK_CFG = CLOCK_CFG & ~ MASK_SYS_CK_SEL | 0x06;  // 24MHz	
      0000E9 74 F8            [12]  584 	mov	a,#0xf8
      0000EB 55 B9            [12]  585 	anl	a,_CLOCK_CFG
      0000ED 44 06            [12]  586 	orl	a,#0x06
      0000EF F5 B9            [12]  587 	mov	_CLOCK_CFG,a
                                    588 ;	../../include/debug.c:51: SAFE_MOD = 0x00;
      0000F1 75 A1 00         [24]  589 	mov	_SAFE_MOD,#0x00
                                    590 ;	../../include/debug.c:52: }
      0000F4 22               [24]  591 	ret
                                    592 ;------------------------------------------------------------
                                    593 ;Allocation info for local variables in function 'mDelayuS'
                                    594 ;------------------------------------------------------------
                                    595 ;n             Allocated to registers 
                                    596 ;------------------------------------------------------------
                                    597 ;	../../include/debug.c:63: void	mDelayuS( uint16_t n )  // Delay in uS
                                    598 ;	-----------------------------------------
                                    599 ;	 function mDelayuS
                                    600 ;	-----------------------------------------
      0000F5                        601 _mDelayuS:
      0000F5 AE 82            [24]  602 	mov	r6, dpl
      0000F7 AF 83            [24]  603 	mov	r7, dph
                                    604 ;	../../include/debug.c:76: while ( n ) {  // total = 12~13 Fsys cycles, 1uS @Fsys=12MHz
      0000F9                        605 00101$:
      0000F9 EE               [12]  606 	mov	a,r6
      0000FA 4F               [12]  607 	orl	a,r7
      0000FB 60 15            [24]  608 	jz	00104$
                                    609 ;	../../include/debug.c:77: ++ SAFE_MOD;  // 2 Fsys cycles, for higher Fsys, add operation here
      0000FD 05 A1            [12]  610 	inc	_SAFE_MOD
                                    611 ;	../../include/debug.c:80: ++ SAFE_MOD;
      0000FF 05 A1            [12]  612 	inc	_SAFE_MOD
                                    613 ;	../../include/debug.c:83: ++ SAFE_MOD;
      000101 05 A1            [12]  614 	inc	_SAFE_MOD
                                    615 ;	../../include/debug.c:86: ++ SAFE_MOD;
      000103 05 A1            [12]  616 	inc	_SAFE_MOD
                                    617 ;	../../include/debug.c:89: ++ SAFE_MOD;
      000105 05 A1            [12]  618 	inc	_SAFE_MOD
                                    619 ;	../../include/debug.c:92: ++ SAFE_MOD;
      000107 05 A1            [12]  620 	inc	_SAFE_MOD
                                    621 ;	../../include/debug.c:95: ++ SAFE_MOD;
      000109 05 A1            [12]  622 	inc	_SAFE_MOD
                                    623 ;	../../include/debug.c:110: -- n;
      00010B 1E               [12]  624 	dec	r6
      00010C BE FF 01         [24]  625 	cjne	r6,#0xff,00120$
      00010F 1F               [12]  626 	dec	r7
      000110                        627 00120$:
      000110 80 E7            [24]  628 	sjmp	00101$
      000112                        629 00104$:
                                    630 ;	../../include/debug.c:112: }
      000112 22               [24]  631 	ret
                                    632 ;------------------------------------------------------------
                                    633 ;Allocation info for local variables in function 'mDelaymS'
                                    634 ;------------------------------------------------------------
                                    635 ;n             Allocated to registers 
                                    636 ;------------------------------------------------------------
                                    637 ;	../../include/debug.c:121: void	mDelaymS( uint16_t n )                                                  // Delay in mS
                                    638 ;	-----------------------------------------
                                    639 ;	 function mDelaymS
                                    640 ;	-----------------------------------------
      000113                        641 _mDelaymS:
      000113 AE 82            [24]  642 	mov	r6, dpl
      000115 AF 83            [24]  643 	mov	r7, dph
                                    644 ;	../../include/debug.c:123: while ( n ) {
      000117                        645 00101$:
      000117 EE               [12]  646 	mov	a,r6
      000118 4F               [12]  647 	orl	a,r7
      000119 60 15            [24]  648 	jz	00104$
                                    649 ;	../../include/debug.c:128: mDelayuS( 1000 );
      00011B 90 03 E8         [24]  650 	mov	dptr,#0x03e8
      00011E C0 07            [24]  651 	push	ar7
      000120 C0 06            [24]  652 	push	ar6
      000122 12 00 F5         [24]  653 	lcall	_mDelayuS
      000125 D0 06            [24]  654 	pop	ar6
      000127 D0 07            [24]  655 	pop	ar7
                                    656 ;	../../include/debug.c:130: -- n;
      000129 1E               [12]  657 	dec	r6
      00012A BE FF 01         [24]  658 	cjne	r6,#0xff,00120$
      00012D 1F               [12]  659 	dec	r7
      00012E                        660 00120$:
      00012E 80 E7            [24]  661 	sjmp	00101$
      000130                        662 00104$:
                                    663 ;	../../include/debug.c:132: }                                         
      000130 22               [24]  664 	ret
                                    665 ;------------------------------------------------------------
                                    666 ;Allocation info for local variables in function 'putchar'
                                    667 ;------------------------------------------------------------
                                    668 ;c             Allocated to registers r6 r7 
                                    669 ;------------------------------------------------------------
                                    670 ;	../../include/debug.c:148: int putchar(int c)
                                    671 ;	-----------------------------------------
                                    672 ;	 function putchar
                                    673 ;	-----------------------------------------
      000131                        674 _putchar:
      000131 AE 82            [24]  675 	mov	r6, dpl
      000133 AF 83            [24]  676 	mov	r7, dph
                                    677 ;	../../include/debug.c:150: while (!TI); /* assumes UART is initialized */
      000135                        678 00101$:
                                    679 ;	../../include/debug.c:151: TI = 0;
                                    680 ;	assignBit
      000135 10 99 02         [24]  681 	jbc	_TI,00118$
      000138 80 FB            [24]  682 	sjmp	00101$
      00013A                        683 00118$:
                                    684 ;	../../include/debug.c:152: SBUF = c & 0xFF;
      00013A 8E 99            [24]  685 	mov	_SBUF,r6
                                    686 ;	../../include/debug.c:154: return c;
      00013C 8E 82            [24]  687 	mov	dpl, r6
      00013E 8F 83            [24]  688 	mov	dph, r7
                                    689 ;	../../include/debug.c:155: }
      000140 22               [24]  690 	ret
                                    691 ;------------------------------------------------------------
                                    692 ;Allocation info for local variables in function 'getchar'
                                    693 ;------------------------------------------------------------
                                    694 ;	../../include/debug.c:157: int getchar() {
                                    695 ;	-----------------------------------------
                                    696 ;	 function getchar
                                    697 ;	-----------------------------------------
      000141                        698 _getchar:
                                    699 ;	../../include/debug.c:158: while(!RI); /* assumes UART is initialized */
      000141                        700 00101$:
                                    701 ;	../../include/debug.c:159: RI = 0;
                                    702 ;	assignBit
      000141 10 98 02         [24]  703 	jbc	_RI,00118$
      000144 80 FB            [24]  704 	sjmp	00101$
      000146                        705 00118$:
                                    706 ;	../../include/debug.c:160: return SBUF;
      000146 AE 99            [24]  707 	mov	r6,_SBUF
      000148 7F 00            [12]  708 	mov	r7,#0x00
      00014A 8E 82            [24]  709 	mov	dpl, r6
      00014C 8F 83            [24]  710 	mov	dph, r7
                                    711 ;	../../include/debug.c:161: }
      00014E 22               [24]  712 	ret
                                    713 	.area CSEG    (CODE)
                                    714 	.area CONST   (CODE)
                                    715 	.area XINIT   (CODE)

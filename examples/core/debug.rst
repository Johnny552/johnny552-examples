      ...
      000000                        498 	.ds 8
                                    ...
                                    562 	.area CSEG    (CODE)
                                    563 ;------------------------------------------------------------
                                    564 ;Allocation info for local variables in function 'CfgFsys'
                                    565 ;------------------------------------------------------------
                                    566 ;	lib/usb_hid/debug.c:24: void	CfgFsys( )  
                                    567 ;	-----------------------------------------
                                    568 ;	 function CfgFsys
                                    569 ;	-----------------------------------------
      00083A                        570 _CfgFsys:
                           000007   571 	ar7 = 0x07
                           000006   572 	ar6 = 0x06
                           ...
                           000001   577 	ar1 = 0x01
                           000000   578 	ar0 = 0x00
                                    579 ;	lib/usb_hid/debug.c:26: SAFE_MOD = 0x55;
      00083A 75 A1 55         [24]  580 	mov	_SAFE_MOD,#0x55
                                    581 ;	lib/usb_hid/debug.c:27: SAFE_MOD = 0xAA;
      00083D 75 A1 AA         [24]  582 	mov	_SAFE_MOD,#0xaa
                                    583 ;	lib/usb_hid/debug.c:34: CLOCK_CFG = CLOCK_CFG & ~ MASK_SYS_CK_SEL | 0x06;  // 24MHz	
      000840 74 F8            [12]  584 	mov	a,#0xf8
      000842 55 B9            [12]  585 	anl	a,_CLOCK_CFG
      000844 44 06            [12]  586 	orl	a,#0x06
      000846 F5 B9            [12]  587 	mov	_CLOCK_CFG,a
                                    588 ;	lib/usb_hid/debug.c:51: SAFE_MOD = 0x00;
      000848 75 A1 00         [24]  589 	mov	_SAFE_MOD,#0x00
                                    590 ;	lib/usb_hid/debug.c:52: }
      00084B 22               [24]  591 	ret
                                    592 ;------------------------------------------------------------
                                    593 ;Allocation info for local variables in function 'mDelayuS'
                                    594 ;------------------------------------------------------------
                                    595 ;n             Allocated to registers 
                                    596 ;------------------------------------------------------------
                                    597 ;	lib/usb_hid/debug.c:63: void	mDelayuS( uint16_t n )  // Delay in uS
                                    598 ;	-----------------------------------------
                                    599 ;	 function mDelayuS
                                    600 ;	-----------------------------------------
      00084C                        601 _mDelayuS:
      00084C AE 82            [24]  602 	mov	r6, dpl
      00084E AF 83            [24]  603 	mov	r7, dph
                                    604 ;	lib/usb_hid/debug.c:76: while ( n ) {  // total = 12~13 Fsys cycles, 1uS @Fsys=12MHz
      000850                        605 00101$:
      000850 EE               [12]  606 	mov	a,r6
      000851 4F               [12]  607 	orl	a,r7
      000852 60 15            [24]  608 	jz	00104$
                                    609 ;	lib/usb_hid/debug.c:77: ++ SAFE_MOD;  // 2 Fsys cycles, for higher Fsys, add operation here
      000854 05 A1            [12]  610 	inc	_SAFE_MOD
                                    611 ;	lib/usb_hid/debug.c:80: ++ SAFE_MOD;
      000856 05 A1            [12]  612 	inc	_SAFE_MOD
                                    613 ;	lib/usb_hid/debug.c:83: ++ SAFE_MOD;
      000858 05 A1            [12]  614 	inc	_SAFE_MOD
                                    615 ;	lib/usb_hid/debug.c:86: ++ SAFE_MOD;
      00085A 05 A1            [12]  616 	inc	_SAFE_MOD
                                    617 ;	lib/usb_hid/debug.c:89: ++ SAFE_MOD;
      00085C 05 A1            [12]  618 	inc	_SAFE_MOD
                                    619 ;	lib/usb_hid/debug.c:92: ++ SAFE_MOD;
      00085E 05 A1            [12]  620 	inc	_SAFE_MOD
                                    621 ;	lib/usb_hid/debug.c:95: ++ SAFE_MOD;
      000860 05 A1            [12]  622 	inc	_SAFE_MOD
                                    623 ;	lib/usb_hid/debug.c:110: -- n;
      000862 1E               [12]  624 	dec	r6
      000863 BE FF 01         [24]  625 	cjne	r6,#0xff,00120$
      000866 1F               [12]  626 	dec	r7
      000867                        627 00120$:
      000867 80 E7            [24]  628 	sjmp	00101$
      000869                        629 00104$:
                                    630 ;	lib/usb_hid/debug.c:112: }
      000869 22               [24]  631 	ret
                                    632 ;------------------------------------------------------------
                                    633 ;Allocation info for local variables in function 'mDelaymS'
                                    634 ;------------------------------------------------------------
                                    635 ;n             Allocated to registers 
                                    636 ;------------------------------------------------------------
                                    637 ;	lib/usb_hid/debug.c:121: void	mDelaymS( uint16_t n )                                                  // Delay in mS
                                    638 ;	-----------------------------------------
                                    639 ;	 function mDelaymS
                                    640 ;	-----------------------------------------
      00086A                        641 _mDelaymS:
      00086A AE 82            [24]  642 	mov	r6, dpl
      00086C AF 83            [24]  643 	mov	r7, dph
                                    644 ;	lib/usb_hid/debug.c:123: while ( n ) {
      00086E                        645 00101$:
      00086E EE               [12]  646 	mov	a,r6
      00086F 4F               [12]  647 	orl	a,r7
      000870 60 15            [24]  648 	jz	00104$
                                    649 ;	lib/usb_hid/debug.c:128: mDelayuS( 1000 );
      000872 90 03 E8         [24]  650 	mov	dptr,#0x03e8
      000875 C0 07            [24]  651 	push	ar7
      000877 C0 06            [24]  652 	push	ar6
      000879 12 08 4C         [24]  653 	lcall	_mDelayuS
      00087C D0 06            [24]  654 	pop	ar6
      00087E D0 07            [24]  655 	pop	ar7
                                    656 ;	lib/usb_hid/debug.c:130: -- n;
      000880 1E               [12]  657 	dec	r6
      000881 BE FF 01         [24]  658 	cjne	r6,#0xff,00120$
      000884 1F               [12]  659 	dec	r7
      000885                        660 00120$:
      000885 80 E7            [24]  661 	sjmp	00101$
      000887                        662 00104$:
                                    663 ;	lib/usb_hid/debug.c:132: }                                         
      000887 22               [24]  664 	ret
                                    665 ;------------------------------------------------------------
                                    666 ;Allocation info for local variables in function 'putchar'
                                    667 ;------------------------------------------------------------
                                    668 ;c             Allocated to registers r6 r7 
                                    669 ;------------------------------------------------------------
                                    670 ;	lib/usb_hid/debug.c:148: int putchar(int c)
                                    671 ;	-----------------------------------------
                                    672 ;	 function putchar
                                    673 ;	-----------------------------------------
      000888                        674 _putchar:
      000888 AE 82            [24]  675 	mov	r6, dpl
      00088A AF 83            [24]  676 	mov	r7, dph
                                    677 ;	lib/usb_hid/debug.c:150: while (!TI); /* assumes UART is initialized */
      00088C                        678 00101$:
                                    679 ;	lib/usb_hid/debug.c:151: TI = 0;
                                    680 ;	assignBit
      00088C 10 99 02         [24]  681 	jbc	_TI,00118$
      00088F 80 FB            [24]  682 	sjmp	00101$
      000891                        683 00118$:
                                    684 ;	lib/usb_hid/debug.c:152: SBUF = c & 0xFF;
      000891 8E 99            [24]  685 	mov	_SBUF,r6
                                    686 ;	lib/usb_hid/debug.c:154: return c;
      000893 8E 82            [24]  687 	mov	dpl, r6
      000895 8F 83            [24]  688 	mov	dph, r7
                                    689 ;	lib/usb_hid/debug.c:155: }
      000897 22               [24]  690 	ret
                                    691 ;------------------------------------------------------------
                                    692 ;Allocation info for local variables in function 'getchar'
                                    693 ;------------------------------------------------------------
                                    694 ;	lib/usb_hid/debug.c:157: int getchar() {
                                    695 ;	-----------------------------------------
                                    696 ;	 function getchar
                                    697 ;	-----------------------------------------
      000898                        698 _getchar:
                                    699 ;	lib/usb_hid/debug.c:158: while(!RI); /* assumes UART is initialized */
      000898                        700 00101$:
                                    701 ;	lib/usb_hid/debug.c:159: RI = 0;
                                    702 ;	assignBit
      000898 10 98 02         [24]  703 	jbc	_RI,00118$
      00089B 80 FB            [24]  704 	sjmp	00101$
      00089D                        705 00118$:
                                    706 ;	lib/usb_hid/debug.c:160: return SBUF;
      00089D AE 99            [24]  707 	mov	r6,_SBUF
      00089F 7F 00            [12]  708 	mov	r7,#0x00
      0008A1 8E 82            [24]  709 	mov	dpl, r6
      0008A3 8F 83            [24]  710 	mov	dph, r7
                                    711 ;	lib/usb_hid/debug.c:161: }
      0008A5 22               [24]  712 	ret
                                    713 	.area CSEG    (CODE)
                                    714 	.area CONST   (CODE)
                                    715 	.area XINIT   (CODE)
